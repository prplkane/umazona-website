...
const extrasGalleryPhotos = [
  {
    src: `${process.env.PUBLIC_URL}/images/DSC_1639.JPG`,
    alt: 'Команда гостей УмAZона радуется после раунда',
    caption: 'Радость победы и дружеская атмосфера на живых играх.',
  },
  {
    src: `${process.env.PUBLIC_URL}/images/DSC_1674.JPG`,
    alt: 'Ведущий УмAZона общается с командой участников',
    caption: 'Ведущие держат динамику вечера, а команды — энергичный настрой.',
  },
];
    ...
    <section id="extras" className="extras-section">
      <div className="extras-wrapper">
        <div className="extras-header">
          ...
          <p>
            Погрузитесь в атмосферу УмAZона: вдохновитесь галереей, вспомните любимые викторины в архиве,
        ...
        <div className="extras-gallery-row">
          {extrasGalleryPhotos.map((photo) => (
            <figure className="extras-gallery-panel" key={photo.src}>
